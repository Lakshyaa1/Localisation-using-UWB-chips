...
# Add coordinates for all 8 anchors
ANCHORS = {
    0x0000: (0.0,   0.0),      # Add your coordinates
    0x0002: (0.0, 150.0),      # Add your coordinates
    0x0003: (0.0, 300.0),      # Add your coordinates
    0x0004: (150.0,   300.0),
    0x0006: (300.0, 300.0),
    0x0007: (300.0, 150.0),
    0x0009: (300.0,   0.0),
...
def main():
    ...
    ser.write(b"stop\r\n")
    time.sleep(0.3)
    # Updated initialization command for 8 anchors
    ser.write(b"initf -multi -addr=1 -paddr=[0,2,3,4,6,7,9,10]\r\n")
    time.sleep(0.3)

    print("\nUWB POSITIONING (STATIONARY MODE – 8 ANCHORS)")
